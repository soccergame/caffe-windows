...
#mkdir log
GLOG_logtostderr=0 GLOG_alsologtostderr=1 $TOOLS/caffe train  --gpu=6 --solver=./solver_shufflenet_beauty.prototxt --weights=./shufflenet_beauty.caffemodel --log_dir=./log 
#--engine=MKL2017 
